...
WORKTREE_DIR=/home/dotmac/projects/dotmac_sub/.worktrees/fix-deps-007
...
LOG_FILE=/home/dotmac/projects/dotmac_sub/.seabone/logs/fix-deps-007.log
TASK_ID=fix-deps-007
DESCRIPTION=Upgrade\ fastapi\ from\ 0.111.0\ to\ \>=0.115.0\ and\ uvicorn\ from\ 0.30.1\ to\ \>=0.34.0\ in\ pyproject.toml.\ These\ upgrades\ include\ security-relevant\ Starlette\ sub-dependency\ fixes\ and\ request\ validation\ improvements.\ After\ editing\ pyproject.toml:\ run\ make\ check\ \&\&\ make\ test\ to\ confirm\ the\ full\ test\ suite\ passes.\ If\ tests\ fail\ due\ to\ FastAPI\ API\ changes\ \(e.g.\ response_model_exclude_unset\ defaults\)\,\ fix\ them.
...
PROMPTS_DIR=/home/dotmac/projects/dotmac_sub/.seabone/prompts
