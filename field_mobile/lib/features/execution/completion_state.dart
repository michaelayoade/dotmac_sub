...
class CompletionState {
  ...
  bool get hasSignOff =>
      hasSignature || (signatureUnavailableReason != null && signatureUnavailableReason!.trim().isNotEmpty);
  ...
  Map<String, dynamic> get transitionPayload => {
        if (signatureUnavailableReason != null && signatureUnavailableReason!.trim().isNotEmpty)
          'signature_unavailable_reason': signatureUnavailableReason!.trim(),
        if (signerName != null && signerName!.trim().isNotEmpty) 'signer_name': signerName!.trim(),
  ...
  CompletionState copyWith({
    ...
    String? summary,
      ...
      CompletionState(
        ...
        signatureUnavailableReason: signatureUnavailableReason ?? this.signatureUnavailableReason,
