...
| `customer.account_recovery` | deletion and recovery eligibility | `resolver` | canonical account recovery tombstone ← `customer.account_recovery` | `participant` | `cut_over` | customer operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/SUBSCRIBER_ACCOUNT_LIFECYCLE_SOURCES.md`<br>`docs/SUBSCRIBER_METADATA_OWNERSHIP.md`<br>`tests/architecture/test_account_recovery_boundary.py`<br>`tests/test_system_restore_tool_service.py`<br>`tests/integration/test_account_recovery_migration.py` |
| `customer.account_recovery` | deletion tombstones | `command_writer` | account recovery command evidence ← `customer.account_recovery`<br>canonical account lifecycle state ← `access.subscription_lifecycle`<br>canonical subscription lifecycle state ← `access.subscription_lifecycle` | `participant` | `cut_over` | customer operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/SUBSCRIBER_ACCOUNT_LIFECYCLE_SOURCES.md`<br>`docs/SUBSCRIBER_METADATA_OWNERSHIP.md`<br>`tests/architecture/test_account_recovery_boundary.py`<br>`tests/test_system_restore_tool_service.py`<br>`tests/integration/test_account_recovery_migration.py` |
| `customer.account_recovery` | recovery evidence re-baselining | `command_writer` | account recovery command evidence ← `customer.account_recovery`<br>canonical account recovery tombstone ← `customer.account_recovery` | `participant` | `cut_over` | customer operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/SUBSCRIBER_ACCOUNT_LIFECYCLE_SOURCES.md`<br>`docs/SUBSCRIBER_METADATA_OWNERSHIP.md`<br>`tests/architecture/test_account_recovery_boundary.py`<br>`tests/test_system_restore_tool_service.py`<br>`tests/integration/test_account_recovery_migration.py` |
| `customer.account_recovery` | recovery confirmation | `command_writer` | account recovery command evidence ← `customer.account_recovery`<br>canonical account recovery tombstone ← `customer.account_recovery`<br>canonical subscription lifecycle state ← `access.subscription_lifecycle` | `participant` | `cut_over` | customer operations | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/SUBSCRIBER_ACCOUNT_LIFECYCLE_SOURCES.md`<br>`docs/SUBSCRIBER_METADATA_OWNERSHIP.md`<br>`tests/architecture/test_account_recovery_boundary.py`<br>`tests/test_system_restore_tool_service.py`<br>`tests/integration/test_account_recovery_migration.py` |
