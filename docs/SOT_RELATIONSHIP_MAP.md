...
| `billing.obligations` | unique billing obligation identity | `authoritative_record` | recorded billing contract terms ← `billing.contracts`<br>recorded billing obligations ← `billing.obligations` | `owner_managed` | `shadowing` | billing and finance operations | `docs/adr/0007-end-to-end-billing-target-architecture.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_billing_obligations.py`<br>`tests/architecture/test_billing_target_architecture.py` |
