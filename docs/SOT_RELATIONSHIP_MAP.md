...
| `sales.crm_quote_retirement` | retired CRM quote execution and action availability | `policy` | approved CRM retirement ← `sales.crm_quote_retirement` | `not_applicable` | `complete` | sales operations | `docs/designs/CRM_QUOTE_RETIREMENT.md`<br>`tests/test_quotes_mirror.py`<br>`tests/architecture/test_crm_quote_retirement.py` |
