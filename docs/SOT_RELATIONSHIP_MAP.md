...
| `financial.service_extensions` | service-extension aggregate lifecycle | `command_writer` | authorized service-extension command ← `auth.permission_gate`<br>canonical service-extension aggregate ← `financial.service_extensions`<br>canonical subscriber scope ← `customer.accounts` | `owner_managed` | `complete` | billing and operations | `docs/designs/SERVICE_EXTENSION_LIFECYCLE_SOT.md`<br>`docs/runbooks/SERVICE_EXTENSION_ACTIVITY_CUTOVER.md`<br>`docs/FINANCIAL_ACCESS_ENFORCEMENT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_service_extensions.py`<br>`tests/test_web_billing_service_extensions.py`<br>`tests/integration/test_service_extension_concurrency.py`<br>`tests/architecture/test_service_extension_sot_boundary.py` |
| `financial.service_extensions` | immutable applied service-extension entry evidence | `authoritative_record` | canonical service-extension aggregate ← `financial.service_extensions`<br>canonical subscription billing anchor ← `access.subscription_lifecycle` | `owner_managed` | `complete` | billing and operations | `docs/designs/SERVICE_EXTENSION_LIFECYCLE_SOT.md`<br>`docs/runbooks/SERVICE_EXTENSION_ACTIVITY_CUTOVER.md`<br>`docs/FINANCIAL_ACCESS_ENFORCEMENT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_service_extensions.py`<br>`tests/test_web_billing_service_extensions.py`<br>`tests/integration/test_service_extension_concurrency.py`<br>`tests/architecture/test_service_extension_sot_boundary.py` |
| `financial.service_extensions` | extension-caused subscription billing-anchor projection | `projection_writer` | canonical service-extension aggregate ← `financial.service_extensions`<br>canonical subscription billing anchor ← `access.subscription_lifecycle`<br>immutable applied service-extension entry evidence ← `financial.service_extensions` | `owner_managed` | `complete` | billing and operations | `docs/designs/SERVICE_EXTENSION_LIFECYCLE_SOT.md`<br>`docs/runbooks/SERVICE_EXTENSION_ACTIVITY_CUTOVER.md`<br>`docs/FINANCIAL_ACCESS_ENFORCEMENT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_service_extensions.py`<br>`tests/test_web_billing_service_extensions.py`<br>`tests/integration/test_service_extension_concurrency.py`<br>`tests/architecture/test_service_extension_sot_boundary.py` |
