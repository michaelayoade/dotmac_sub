...
| `communications.staff_notifications` | admin/staff notification creation | `command_writer` | validated staff assignment notification command ← `communications.staff_notifications`<br>canonical staff account identity ← `auth.staff_provisioning`<br>canonical internal notification row ← `communications.notification_service` | `participant` | `complete` | customer experience platform | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/NOTIFICATION_CHANNEL_POLICY.md`<br>`docs/designs/SUPPORT_TICKET_LIFECYCLE_SOT.md`<br>`tests/test_staff_assignment_notifications.py`<br>`tests/test_support_services.py`<br>`tests/architecture/test_sot_manifest_contracts.py` |
| `communications.staff_notifications` | permission-targeted staff notification audience resolution | `resolver` | validated staff assignment notification command ← `communications.staff_notifications`<br>canonical staff account identity ← `auth.staff_provisioning` | `participant` | `complete` | customer experience platform | `docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/designs/NOTIFICATION_CHANNEL_POLICY.md`<br>`docs/designs/SUPPORT_TICKET_LIFECYCLE_SOT.md`<br>`tests/test_staff_assignment_notifications.py`<br>`tests/test_support_services.py`<br>`tests/architecture/test_sot_manifest_contracts.py` |
