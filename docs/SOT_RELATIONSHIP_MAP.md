...
| `operations.field_presence` | field workforce presence status | `authoritative_record` | typed field presence status command ← `operations.field_presence`<br>authenticated field technician principal ← `auth.permission_gate`<br>staff-linked field technician profile ← `auth.staff_provisioning`<br>current field workforce presence status ← `operations.field_presence` | `owner_managed` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
| `operations.field_geofence_policy` | field work-order geofence consequence policy | `event_policy` | committed field position observation event ← `events.store`<br>retained field position observation ← `operations.position_observations`<br>current field technician position projection ← `operations.position_observations`<br>field geofence policy settings ← `control.domain_settings`<br>current field work-order transition state ← `operations.field_completion` | `not_applicable` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
| `operations.position_observations` | field position observations | `observation_collector` | typed field position observation batch ← `operations.position_observations`<br>authenticated field technician principal ← `auth.permission_gate`<br>staff-linked field technician profile ← `auth.staff_provisioning` | `owner_managed` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
| `operations.position_observations` | field technician current-position projection | `projection_writer` | current field position observations ← `operations.position_observations` | `owner_managed` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
| `operations.position_observations` | field location collection grant | `authoritative_record` | typed field location collection command ← `operations.position_observations`<br>authenticated field technician principal ← `auth.permission_gate`<br>staff-linked field technician profile ← `auth.staff_provisioning` | `owner_managed` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
| `operations.position_observations` | position observation retention | `command_writer` | typed position observation retention command ← `operations.position_observations`<br>current field position observations ← `operations.position_observations` | `owner_managed` | `cut_over` | field operations | `docs/designs/POSITION_OBSERVATION_SOT.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_field_location_tracking.py`<br>`tests/architecture/test_position_observation_boundary.py` |
