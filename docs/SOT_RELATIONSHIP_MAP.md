...
| `customer.name_remediation` | July 20 CRM name remediation manifest execution | `application_coordinator` | CRM identity-change audit evidence ← `observability.audit_log`<br>legacy Subscriber name state ← `customer.accounts` | `owner_managed` | `complete` | customer operations | `docs/PARTY_CUSTOMER_LIFECYCLE.md`<br>`tests/test_crm_customer_name_repair.py` |
...
| `crm.ai_intake` | customer-message classification and follow-up state | `authoritative_record` | committed inbound customer message ← `communications.team_inbox_processing`<br>customer AI intake configuration ← `crm.ai_intake`<br>strict AI classification observation ← `external:configured_ai_provider` | `owner_managed` | `complete` | customer experience platform | `docs/designs/CUSTOMER_AI_INTAKE.md`<br>`docs/designs/AI_SOT.md`<br>`docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_customer_ai_intake.py`<br>`tests/test_team_inbox_channel_receive.py`<br>`tests/test_team_inbox_routing.py` |
| `crm.ai_intake` | customer-intake destination decision | `policy` | customer AI intake decision ← `crm.ai_intake`<br>configured Inbox team routes ← `communications.team_inbox_routing` | `owner_managed` | `complete` | customer experience platform | `docs/designs/CUSTOMER_AI_INTAKE.md`<br>`docs/designs/AI_SOT.md`<br>`docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`tests/test_customer_ai_intake.py`<br>`tests/test_team_inbox_channel_receive.py`<br>`tests/test_team_inbox_routing.py` |
...
| `sales.lead_intake` | versioned lead-intake template lifecycle | `application_coordinator` | authenticated Lead intake template command ← `sales.lead_intake`<br>canonical Sales routing configuration ← `sales.service` | `coordinator_managed` | `complete` | sales operations | `docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/PARTY_CUSTOMER_LIFECYCLE.md`<br>`docs/designs/INBOX_CONVERSATION_PARTICIPANTS.md`<br>`docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_lead_intake.py`<br>`tests/test_web_lead_intake.py`<br>`tests/architecture/test_lead_intake_boundary.py` |
| `sales.lead_intake` | sales lead eligibility and invitation lifecycle | `application_coordinator` | canonical unknown Inbox conversation state ← `communications.team_inbox_processing`<br>shared customer intake sales handoff ← `crm.ai_intake`<br>explicit Lead intake rollout configuration ← `control.settings_spec`<br>published Lead intake template versions ← `sales.lead_intake` | `coordinator_managed` | `complete` | sales operations | `docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/PARTY_CUSTOMER_LIFECYCLE.md`<br>`docs/designs/INBOX_CONVERSATION_PARTICIPANTS.md`<br>`docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_lead_intake.py`<br>`tests/test_web_lead_intake.py`<br>`tests/architecture/test_lead_intake_boundary.py` |
| `sales.lead_intake` | atomic Inbox form to Party and Lead conversion | `application_coordinator` | validated public Lead intake submission ← `sales.lead_intake`<br>canonical Lead intake invitation ← `sales.lead_intake`<br>server-resolved Nigerian service address ← `gis.geocoding`<br>canonical Party identity state ← `party.registry`<br>canonical Lead lifecycle state ← `sales.lead_lifecycle`<br>canonical unknown Inbox conversation state ← `communications.team_inbox_processing` | `coordinator_managed` | `complete` | sales operations | `docs/designs/INBOX_LEAD_INTAKE.md`<br>`docs/SOT_RELATIONSHIP_MAP.md`<br>`docs/PARTY_CUSTOMER_LIFECYCLE.md`<br>`docs/designs/INBOX_CONVERSATION_PARTICIPANTS.md`<br>`docs/designs/SALES_TO_SERVICE_LIFECYCLE_SOT.md`<br>`tests/test_lead_intake.py`<br>`tests/test_web_lead_intake.py`<br>`tests/architecture/test_lead_intake_boundary.py` |
