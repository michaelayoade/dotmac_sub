...
| `tests/test_integration_meta_social.py` | `test_typed_facade_returns_sanitized_outcome` | `outbound_transport` | `fc7bb83c3ed15b6a49fa08d1d7991abaed40008d6704adb24afb268e64d96670` |
