...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_subscription_change_requests_subscription_id",
        "subscription_change_requests",
        ["subscription_id"],
    )
    op.create_index(
        "ix_subscription_change_requests_status",
        "subscription_change_requests",
        ["status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "approved_by_person_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
    ...
    op.create_index(
        "ix_payment_arrangements_account_id", "payment_arrangements", ["account_id"]
    )
    op.create_index(
        "ix_payment_arrangements_status", "payment_arrangements", ["status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "due", "paid", "overdue", "waived", name="installmentstatus"
            ),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_index(
        "ix_payment_arrangement_installments_arrangement_id",
        "payment_arrangement_installments",
        ["arrangement_id"],
    )
    op.create_index(
        "ix_payment_arrangement_installments_due_date",
        "payment_arrangement_installments",
        ["due_date"],
    )
    op.create_index(
        "ix_payment_arrangement_installments_status",
        "payment_arrangement_installments",
        ["status"],
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "channel",
            "category",
            name="uq_notification_preferences_account_channel_category",
        ),
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_index(
        "ix_notification_preferences_account_id", table_name="notification_preferences"
    )
    ...
    op.drop_index(
        "ix_payment_arrangements_account_id", table_name="payment_arrangements"
    )
