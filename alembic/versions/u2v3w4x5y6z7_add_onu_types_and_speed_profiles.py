...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "gpon_channel",
            postgresql.ENUM(
                "gpon", "xg_pon", "xgs_pon", name="gponchannel", create_type=False
            ),
            nullable=False,
            server_default="gpon",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "direction",
            postgresql.ENUM(
                "download", "upload", name="speedprofiledirection", create_type=False
            ),
            nullable=False,
        ),
        ...
        sa.Column(
            "speed_type",
            postgresql.ENUM(
                "internet", "management", name="speedprofiletype", create_type=False
            ),
            nullable=False,
        ...
        sa.UniqueConstraint(
            "name", "direction", name="uq_speed_profiles_name_direction"
        ),
    )
    ...
    new_columns = [
        ...
        (
            "onu_mode",
            postgresql.ENUM("routing", "bridging", name="onumode", create_type=False),
            {"nullable": True},
        ),
        ...
        (
            "config_method",
            postgresql.ENUM("omci", "tr069", name="configmethod", create_type=False),
            {"nullable": True},
        ),
        (
            "ip_protocol",
            postgresql.ENUM("ipv4", "dual_stack", name="ipprotocol", create_type=False),
            {"nullable": True},
        ),
        ...
        (
            "mgmt_ip_mode",
            postgresql.ENUM(
                "inactive", "static_ip", "dhcp", name="mgmtipmode", create_type=False
            ),
            {"nullable": True},
        ),
    ...
    existing_fks = {
        fk["name"] for fk in inspector.get_foreign_keys("ont_units") if fk.get("name")
    }
