...
Revision ID: 373_device_projection_class_facts
Revises: 372_dashboard_device_metrics_index
"""
...
revision = "373_device_projection_class_facts"
down_revision = "372_dashboard_device_metrics_index"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.add_column(
        "device_projections",
        sa.Column("class_facts", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    )
