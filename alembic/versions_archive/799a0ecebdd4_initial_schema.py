...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("running", "success", "failed", name="billingrunstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "buildout_status",
            sa.Enum(
                "planned", "in_progress", "ready", "not_planned", name="buildoutstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "sent", "failed", name="customernotificationstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "area_type",
            sa.Enum("coverage", "service_area", "region", "custom", name="geoareatype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "layer_type",
            sa.Enum(
                "points", "lines", "polygons", "heatmap", "cluster", name="geolayertype"
            ),
            nullable=False,
        ),
        sa.Column(
            "source_type",
            sa.Enum("locations", "areas", name="geolayersource"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "assignment_type",
            sa.Enum("bidding", "direct", name="vendorassignmenttype"),
            nullable=True,
        ),
        sa.Column(
            "status",
            sa.Enum(
                ...
                "verified",
                "assigned",
                name="installationprojectstatus",
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=120), nullable=False),
        sa.Column(
            "ip_version", sa.Enum("ipv4", "ipv6", name="ipversion"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "vendor",
            sa.Enum("mikrotik", "cisco", "other", name="nasvendor"),
            nullable=False,
        ),
        sa.Column("ip_address", sa.String(length=64), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "proration_policy",
            sa.Enum("immediate", "next_cycle", "none", name="prorationpolicy"),
            nullable=False,
        ),
        sa.Column(
            "downgrade_policy",
        ...
        sa.Column(
            "suspension_action",
            sa.Enum("none", "throttle", "suspend", "reject", name="suspensionaction"),
            nullable=False,
        ),
        sa.Column(
            "refund_policy",
            sa.Enum("none", "prorated", "full_within_days", name="refundpolicy"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "vendor",
            sa.Enum(
                "mikrotik", "huawei", "zte", "nokia", "other", name="provisioningvendor"
            ),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "draft", "reviewed", "applied", "canceled", name="slacreditreportstatus"
            ),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_type",
            sa.Enum("ticket", "work_order", "project_task", name="workflowentitytype"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("is_active", sa.Boolean(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "auth_protocol",
            sa.Enum("none", "md5", "sha", name="snmpauthprotocol"),
            nullable=False,
        ),
        sa.Column("auth_secret_hash", sa.String(length=255), nullable=True),
        sa.Column(
            "priv_protocol",
            sa.Enum("none", "des", "aes", name="snmpprivprotocol"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("running", "success", "failed", name="usageratingrunstatus"),
            nullable=False,
        ),
        sa.Column("subscriptions_scanned", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "price_type",
            sa.Enum("recurring", "one_time", "usage", name="pricetype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "billing_cycle",
            sa.Enum("monthly", "annual", name="billingcycle"),
            nullable=True,
        ),
        sa.Column(
            "unit",
            sa.Enum("month", "gb", "tb", "item", name="priceunit"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "service_type",
            sa.Enum("residential", "business", name="servicetype"),
            nullable=False,
        ),
        sa.Column(
            "access_type",
            sa.Enum("fiber", "fixed_wireless", "dsl", "cable", name="accesstype"),
            nullable=False,
        ),
        sa.Column(
            "price_basis",
            sa.Enum("flat", "usage", "tiered", "hybrid", name="pricebasis"),
            nullable=False,
        ),
        sa.Column(
            "billing_cycle",
        ...
        sa.Column(
            "status",
            sa.Enum("active", "inactive", "archived", name="offerstatus"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column("is_active", sa.Boolean(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "segment_type",
            sa.Enum("feeder", "distribution", "drop", name="fibersegmenttype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider_type",
            sa.Enum("stripe", "paypal", "manual", "custom", name="paymentprovidertype"),
            nullable=False,
        ),
        sa.Column("connector_config_id", sa.UUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "action",
            sa.Enum("notify", "throttle", "suspend", "reject", name="dunningaction"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "accepted",
                "rejected",
                name="proposedrouterevisionstatus",
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "step_type",
            sa.Enum(
                "assign_ont", "push_config", "confirm_up", name="provisioningsteptype"
            ),
            nullable=False,
        ),
        sa.Column("order_index", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "server_id", "client_ip", name="uq_radius_clients_server_ip"
        ),
    )
    op.create_table(
        "radius_sync_jobs",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "reseller_id", "person_id", name="uq_reseller_users_reseller_person"
        ),
    )
    op.create_table(
        "role_permissions",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "running", "paused", "completed", "breached", name="slaclockstatus"
            ),
            nullable=False,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name="ck_subscribers_person_or_org",
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"],
            ["organizations.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("local", "sso", "radius", name="authprovider"),
            nullable=False,
        ),
    ...
    op.create_index(
        ...
        unique=True,
        sqlite_where=sa.text("channel_target_id IS NULL"),
        postgresql_where=sa.text("channel_target_id IS NULL"),
    )
    op.create_table(
        "device_interfaces",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("up", "down", "unknown", name="interfacestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "job_type",
            sa.Enum("sync", "export", "import_", name="integrationjobtype"),
            nullable=False,
        ),
        sa.Column(
            "schedule_type",
            sa.Enum("manual", "interval", name="integrationscheduletype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("running", "success", "failed", name="radiussyncstatus"),
            nullable=False,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("finished_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("open", "acknowledged", "resolved", name="slabreachstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "active", "suspended", "canceled", "delinquent", name="accountstatus"
            ),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "address_type",
            sa.Enum("service", "billing", "mailing", name="addresstype"),
            nullable=False,
        ),
        sa.Column("label", sa.String(length=120), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "operator",
            sa.Enum("gt", "gte", "lt", "lte", "eq", name="alertoperator"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("open", "paused", "resolved", "closed", name="dunningcasestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("running", "success", "failed", name="integrationrunstatus"),
            nullable=False,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("finished_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "port_type",
            sa.Enum("pon", "uplink", "ethernet", "mgmt", name="oltporttype"),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "normal", "high", "urgent", name="projectpriority"),
            nullable=False,
        ),
        sa.Column("account_id", sa.UUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "port_type",
            sa.Enum("input", "output", name="splitterporttype"),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "delivered", "failed", name="webhookdeliverystatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "account_type",
            sa.Enum("checking", "savings", "business", "other", name="bankaccounttype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "eligible", "ineligible", "needs_buildout", name="qualificationstatus"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["policy_id"],
            ["alert_notification_policies.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "alert_notification_policy_steps",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("policy_id", sa.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "device_type",
            sa.Enum("ont", "router", "modem", "cpe", name="devicetype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("active", "inactive", "retired", name="cpe_devicestatus"),
            nullable=False,
        ),
        sa.Column("serial_number", sa.String(length=120), nullable=True),
        sa.Column("model", sa.String(length=120), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "tax_application",
            sa.Enum("exclusive", "inclusive", "exempt", name="taxapplication"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "processed", "failed", name="paymentprovidereventstatus"
            ),
            nullable=False,
        ),
        sa.Column("payload", sa.JSON(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status_type",
            sa.Enum("start", "interim", "stop", name="accountingstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum("web", "email", "phone", "chat", "api", name="ticketchannel"),
            nullable=False,
        ),
        sa.Column("tags", sa.JSON(), nullable=True),
        sa.Column("metadata", sa.JSON(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "open", "pending", "snoozed", "resolved", name="conversationstatus"
            ),
            nullable=False,
        ),
        sa.Column("subject", sa.String(length=200), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
            "(ip_version = 'ipv4' AND ipv4_address_id IS NOT NULL AND ipv6_address_id IS NULL) OR (ip_version = 'ipv6' AND ipv6_address_id IS NOT NULL AND ipv4_address_id IS NULL)",
    ...
    op.create_table(
        ...
        sa.Column(
            "port_type",
            sa.Enum("pon", "ethernet", "wifi", "mgmt", name="porttype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("up", "down", "disabled", name="portstatus"),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "running", "success", "failed", name="provisioningrunstatus"
            ),
            nullable=False,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "staged", "posted", "needs_review", "skipped", name="usagechargestatus"
            ),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("radius", "dhcp", "snmp", "api", name="usagesource"),
            nullable=False,
        ),
        sa.Column("recorded_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "normal", "high", "urgent", name="workorderpriority"),
            nullable=False,
        ),
        sa.Column(
            "work_type",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "conversation_id", "tag", name="uq_crm_conversation_tags_conversation_tag"
        ),
    )
    op.create_table(
        "crm_messages",
        ...
        sa.Column(
            "status",
            sa.Enum("received", "queued", "sent", "failed", name="messagestatus"),
            nullable=False,
        ),
        sa.Column("subject", sa.String(length=200), nullable=True),
        sa.Column("body", sa.Text(), nullable=True),
    ...
    op.create_index(
        ...
        [
            "channel_type",
            sa.text(
                "coalesce(channel_target_id, '00000000-0000-0000-0000-000000000000')"
            ),
            "external_id",
        ],
        unique=True,
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "released", "consumed", name="reservationstatus"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("queued", "assigned", "skipped", name="dispatchqueuestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("required", "reserved", "used", name="materialstatus"),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    ...
    # NOTE: PostGIS Tiger geocoder tables (pagc_gaz, faces, addr, edges, etc.)
    # were incorrectly captured by autogenerate — they are extension-managed.
    # Removed ~64 lines of drop_table/drop_index for Tiger geocoder tables.

    # Deferred FK constraints for tables with circular/forward references
    op.create_foreign_key(
        "fk_installation_projects_account_id",
        "installation_projects",
        "subscriber_accounts",
        ["account_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_address_id",
        "installation_projects",
        "addresses",
        ["address_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_approved_quote_id",
        "installation_projects",
        "project_quotes",
        ["approved_quote_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_assigned_vendor_id",
        "installation_projects",
        "vendors",
        ["assigned_vendor_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_buildout_project_id",
        "installation_projects",
        "buildout_projects",
        ["buildout_project_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_created_by_person_id",
        "installation_projects",
        "people",
        ["created_by_person_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_installation_projects_project_id",
        "installation_projects",
        "projects",
        ["project_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_project_quotes_created_by_person_id",
        "project_quotes",
        "people",
        ["created_by_person_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "fk_project_quotes_reviewed_by_person_id",
        "project_quotes",
        "people",
        ["reviewed_by_person_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_service_qualifications_geom",
        table_name="service_qualifications",
    ...
    op.drop_index(
        "idx_geo_locations_geom", table_name="geo_locations", postgresql_using="gist"
    )
    ...
    op.drop_index(
        "idx_as_built_routes_route_geom",
        table_name="as_built_routes",
        postgresql_using="gist",
    )
    ...
    op.drop_index(
        "idx_proposed_route_revisions_route_geom",
        table_name="proposed_route_revisions",
        postgresql_using="gist",
    )
    ...
    op.drop_index(
        "idx_fiber_segments_route_geom",
        table_name="fiber_segments",
        postgresql_using="gist",
    )
    op.drop_table("fiber_segments")
    op.drop_index(
        "idx_fdh_cabinets_geom", table_name="fdh_cabinets", postgresql_using="gist"
    )
    ...
    op.drop_index(
        "idx_fiber_splice_closures_geom",
    ...
    op.drop_index(
        "idx_coverage_areas_geom", table_name="coverage_areas", postgresql_using="gist"
    )
