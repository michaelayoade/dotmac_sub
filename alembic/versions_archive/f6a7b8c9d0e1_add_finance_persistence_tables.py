...
down_revision: str | Sequence[str] | None = "1c0efbd4db66"
...
def upgrade() -> None:
    op.add_column(
        "invoices",
        sa.Column(
            "is_proforma", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
    )
    op.create_index(
        "ix_invoices_is_proforma", "invoices", ["is_proforma"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "run_time", sa.String(length=8), nullable=False, server_default="02:00"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "statement_rows", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "imported_rows", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "unmatched_rows", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "system_payment_count",
            sa.Integer(),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "amount", sa.Numeric(14, 2), nullable=False, server_default=sa.text("0")
        ),
...
def downgrade() -> None:
    op.drop_index(
        "ix_bank_reconciliation_items_run_id", table_name="bank_reconciliation_items"
    )
    op.drop_table("bank_reconciliation_items")

    op.drop_index(
        "ix_bank_reconciliation_runs_created_at", table_name="bank_reconciliation_runs"
    )
