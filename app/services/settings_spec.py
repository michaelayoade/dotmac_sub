...
SETTINGS_SPECS.extend(
    [
        ...
        SettingSpec(
            ...
            key="location_collection_lease_minutes",
            env_var="FIELD_LOCATION_COLLECTION_LEASE_MINUTES",
            value_type=SettingValueType.integer,
            default=720,
            min_value=15,
            max_value=1440,
            label="Field location collection lease (minutes)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_max_batch_size",
            env_var="FIELD_LOCATION_MAX_BATCH_SIZE",
            value_type=SettingValueType.integer,
            default=200,
            min_value=1,
            max_value=1000,
            label="Field location maximum ingest batch size",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_max_future_skew_seconds",
            env_var="FIELD_LOCATION_MAX_FUTURE_SKEW_SECONDS",
            value_type=SettingValueType.integer,
            default=300,
            min_value=0,
            max_value=86400,
            label="Field location maximum future clock skew (seconds)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_max_accuracy_meters",
            env_var="FIELD_LOCATION_MAX_ACCURACY_METERS",
            value_type=SettingValueType.integer,
            default=1000,
            min_value=1,
            max_value=100000,
            label="Field location maximum accepted accuracy radius (metres)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_customer_stale_seconds",
            env_var="FIELD_LOCATION_CUSTOMER_STALE_SECONDS",
            value_type=SettingValueType.integer,
            default=120,
            min_value=15,
            max_value=3600,
            label="Customer-visible field location freshness (seconds)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_geofence_stale_seconds",
            env_var="FIELD_LOCATION_GEOFENCE_STALE_SECONDS",
            value_type=SettingValueType.integer,
            default=120,
            min_value=15,
            max_value=3600,
            label="Field geofence observation freshness (seconds)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_ping_retention_hours",
            env_var="FIELD_LOCATION_PING_RETENTION_HOURS",
            value_type=SettingValueType.integer,
            default=720,
            min_value=1,
            max_value=8760,
            label="Field location observation retention (hours)",
        ),
        SettingSpec(
            domain=SettingDomain.field,
            key="location_retention_sweep_interval_seconds",
            env_var="FIELD_LOCATION_RETENTION_SWEEP_INTERVAL_SECONDS",
            value_type=SettingValueType.integer,
            default=3600,
            min_value=300,
            max_value=86400,
            label="Field location retention sweep interval (seconds)",
        ),
    ]
)
...
DOMAIN_SETTINGS_SERVICE = {
    ...
    SettingDomain.field: settings_service.field_settings,
