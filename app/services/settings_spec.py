...
SETTINGS_SPECS: list[SettingSpec] = [
    ...
    SettingSpec(
        ...
        env_var="VAS_PURCHASE_DEDUPE_WINDOW_SECONDS",
        value_type=SettingValueType.integer,
        default=300,
        min_value=0,
    ),
    SettingSpec(
        ...
        env_var="VAS_PAY_BILL_DEDUPE_WINDOW_SECONDS",
        value_type=SettingValueType.integer,
        default=60,
        min_value=0,
    ),
    SettingSpec(
        ...
        env_var="VAS_REQUERY_MAX_ATTEMPTS",
        value_type=SettingValueType.integer,
        default=10,
        min_value=1,
    ),
    SettingSpec(
        ...
        env_var="VAS_SLOW_SETTLEMENT_CATEGORIES",
        value_type=SettingValueType.string,
    ...
    SettingSpec(
        ...
        env_var="VTPASS_GET_TIMEOUT_SECONDS",
        value_type=SettingValueType.integer,
        default=20,
        min_value=1,
    ),
    SettingSpec(
        ...
        env_var="VTPASS_POST_TIMEOUT_SECONDS",
        value_type=SettingValueType.integer,
        default=45,
        min_value=1,
    ),
    SettingSpec(
        ...
        env_var="VTPASS_VERIFY_TIMEOUT_SECONDS",
        value_type=SettingValueType.integer,
        default=20,
        min_value=1,
    ),
    SettingSpec(
        ...
        env_var="VTPASS_REQUERY_TIMEOUT_SECONDS",
        value_type=SettingValueType.integer,
        default=20,
        min_value=1,
    ),
