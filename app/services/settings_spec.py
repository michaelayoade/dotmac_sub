...
SETTINGS_SPECS: list[SettingSpec] = [
    ...
    SettingSpec(
        ...
        env_var="BILLING_PAYMENT_GATEWAY_PRIMARY_PROVIDER",
        value_type=SettingValueType.string,
        default="paystack",
        allowed={"paystack", "flutterwave"},
    ),
    SettingSpec(
        ...
        env_var="BILLING_PAYMENT_GATEWAY_SECONDARY_PROVIDER",
        value_type=SettingValueType.string,
        default="flutterwave",
        allowed={"paystack", "flutterwave"},
    ),
    ...
    SettingSpec(
        ...
        min_value=1,
        max_value=365,
        label="Service Extension Max Days",
    ),
    SettingSpec(
        domain=SettingDomain.billing,
        key="payment_arrangement_min_installments",
        env_var="BILLING_PAYMENT_ARRANGEMENT_MIN_INSTALLMENTS",
        value_type=SettingValueType.integer,
        default=2,
        min_value=1,
        max_value=120,
        label="Payment Arrangement Min Installments",
    ),
    SettingSpec(
        domain=SettingDomain.billing,
        key="payment_arrangement_max_installments",
        env_var="BILLING_PAYMENT_ARRANGEMENT_MAX_INSTALLMENTS",
        value_type=SettingValueType.integer,
        default=24,
        min_value=1,
        max_value=120,
        label="Payment Arrangement Max Installments",
    ),
    SettingSpec(
        domain=SettingDomain.billing,
        key="payment_arrangement_default_overdue_installments",
        env_var="BILLING_PAYMENT_ARRANGEMENT_DEFAULT_OVERDUE_INSTALLMENTS",
        value_type=SettingValueType.integer,
        default=2,
        min_value=1,
        max_value=120,
