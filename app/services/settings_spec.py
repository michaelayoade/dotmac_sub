...
SETTINGS_SPECS: list[SettingSpec] = [
    ...
    SettingSpec(
        domain=SettingDomain.network_monitoring,
        key="outage_autodetect_lookback_minutes",
        label="Outage Auto-detect Lookback Window (minutes)",
        env_var="OUTAGE_AUTODETECT_LOOKBACK_MINUTES",
        value_type=SettingValueType.integer,
        default=15,
        min_value=5,
        max_value=180,
    ...
    SettingSpec(
        ...
        label="Outage Auto-detect Min Affected Devices",
    ...
    SettingSpec(
        ...
        label="Outage Auto-detect Min Affected Fraction (%)",
