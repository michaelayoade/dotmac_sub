...
SETTINGS_CATEGORIES: list[dict] = [
    ...
    },
    {
        ...
        "color": "emerald",
        "description": "Invoicing, payments, and financial automation",
        "links": [
            ...
            {"name": "Payment Methods", "url": "/admin/system/config/payment-methods", "description": "Cash, bank, online gateways"},
            {"name": "Tax Configuration", "url": "/admin/system/config/tax", "description": "Tax rates and tax groups"},
