    ...
    def create(
        ...
        *,
        ...
        onu_type = OnuType(
            ...
            lan_ip_address_path=lan_ip_address_path,
            lan_subnet_mask_path=lan_subnet_mask_path,
            lan_dhcp_enabled_path=lan_dhcp_enabled_path,
            lan_dhcp_start_path=lan_dhcp_start_path,
            lan_dhcp_end_path=lan_dhcp_end_path,
            remote_access_enabled_path=remote_access_enabled_path,
            http_management_enabled_path=http_management_enabled_path,
