...
4. device_state: resolves NOC operational state from poll/live/admin signals.
...
10. outage_lifecycle: owns incident transitions and their event consequences.
...
SOT_RELATIONSHIPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("outage_impact", ("access_path",)),
    ("outage_lifecycle", ("outage_impact",)),
)
