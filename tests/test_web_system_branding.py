...
def test_settings_branding_update_ignores_non_subscriber_uploaded_by(
    ...
    response = system_web.settings_branding_update(
        ...
        brand_semantic_positive_color=None,
        brand_semantic_info_color=None,
        brand_semantic_warning_color=None,
        brand_semantic_negative_color=None,
        brand_semantic_neutral_color=None,
